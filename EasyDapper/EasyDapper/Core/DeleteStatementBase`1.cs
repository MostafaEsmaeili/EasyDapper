...
{
    public abstract class DeleteStatementBase<TEntity> : SqlStatement<TEntity, int>, IDeleteStatement<TEntity>,
        ...
        where TEntity : class, new()
    {
        ...
        public IDeleteStatement<TEntity> NestedAnd(
        ...
        public IDeleteStatement<TEntity> NestedOr(
            Expression<Func<TEntity, bool>> expression)
        {
        ...
        public IDeleteStatement<TEntity> Where(
            Expression<Func<TEntity, bool>> expression)
        {
            if (entity != null)
                throw new InvalidOperationException(
        ...
        public IDeleteStatement<TEntity> WhereIn<T, TMember>(
