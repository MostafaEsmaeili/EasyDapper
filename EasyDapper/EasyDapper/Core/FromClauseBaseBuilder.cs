...
namespace EasyDapper.Core
{
    public abstract class FromClauseBaseBuilder : ClauseBuilder, IFromClauseBuilder, IClauseBuilder
    {
        ...
        public IFromClauseBuilder From<TEntity>(
        ...
        public IFromClauseBuilder InnerJoin<TLeft, TRight>(
            ...
            string rightTableSchema = null)
        {
            ...
            AddTableSpecification<TRight>("INNER JOIN", rightTableName, rightTableSchema, rightTableAlias,
                typeof(TLeft), leftTableAlias);
            return this;
        }

        public IFromClauseBuilder LeftOuterJoin<TLeft, TRight>(
            string leftTableAlias = null,
            string rightTableAlias = null,
            string rightTableName = null,
            string rightTableSchema = null)
        {
            ThrowIfAliasingInvalid<TLeft, TRight>(leftTableAlias, rightTableAlias);
            AddTableDefinition<TRight>(rightTableAlias, rightTableName, rightTableSchema);
            AddTableSpecification<TRight>("LEFT OUTER JOIN", rightTableName, rightTableSchema, rightTableAlias,
                typeof(TLeft), leftTableAlias);
            return this;
        }

        public IFromClauseBuilder On<TLeft, TRight>(
        ...
        public IFromClauseBuilder RightOuterJoin<TLeft, TRight>(
            string leftTableAlias = null,
            string rightTableAlias = null,
            string rightTableName = null,
            string rightTableSchema = null)
        {
            ThrowIfAliasingInvalid<TLeft, TRight>(leftTableAlias, rightTableAlias);
            AddTableDefinition<TRight>(rightTableAlias, rightTableName, rightTableSchema);
            AddTableSpecification<TRight>("RIGHT OUTER JOIN", rightTableName, rightTableSchema, rightTableAlias,
                typeof(TLeft), leftTableAlias);
            return this;
        }
        ...
        protected void AddTableDefinition<TEntity>(
            string tableAlias,
            string tableName,
            string tableSchema)
        {
        ...
        protected void ThrowIfAliasingInvalid<TLeft, TRight>(
        ...
        protected abstract void AddTableSpecification<TEntity>(
        ...
        protected abstract JoinConditionBase GetCondition<TLeft, TRight>(
